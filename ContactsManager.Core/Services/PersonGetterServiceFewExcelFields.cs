...
namespace Services
{
    public class PersonGetterServiceFewExcelFields : IPersonsGetterServices
    {
        private readonly PersonsGetterServices _personGetterService;

        public PersonGetterServiceFewExcelFields(PersonsGetterServices personGetterService)
        {
