...
namespace Services
{
    public class PersonsSorterServices : IPersonsSorterServices
    {
        private readonly IPersonsRepository _personsRepository;
        private readonly ILogger<PersonsGetterServices> _logger;
        private readonly IDiagnosticContext _diagnosticContext;

        public PersonsSorterServices(IPersonsRepository personsDbContext, ILogger<PersonsGetterServices> logger,
